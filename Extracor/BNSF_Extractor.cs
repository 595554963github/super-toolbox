...
namespace super_toolbox
{
    public class BNSF_Extractor : BaseExtractor
    {
        ...
        private static readonly byte[] BLOCK1 = { 0x49, 0x53, 0x31, 0x34, 0x73, 0x66, 0x6D, 0x74 };
        private static readonly byte[] BLOCK2 = { 0x49, 0x53, 0x32, 0x32, 0x73, 0x66, 0x6D, 0x74 };
        ...
        {
            if (index + 12 > buffer.Length)
            {
                return false;
            }
            return StartsWith(buffer, BLOCK1, index + 8) || StartsWith(buffer, BLOCK2, index + 8);
        }

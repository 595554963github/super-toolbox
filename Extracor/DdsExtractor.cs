...
namespace super_toolbox
{
    public class DdsExtractor : BaseExtractor
    {
        ...
        public override async Task ExtractAsync(string directoryPath, CancellationToken cancellationToken = default)
        {
            ...
            ExtractionProgress?.Invoke(this, $"提取完成:共提取{_extractedFileCount}个DDS文件");
        }
        ...
        private void SaveDdsFile(byte[] ddsData, string extractedFolder, string sourceFileName, int fileCount)
        {
            ...
            try
            {
                ...
                FileExtracted?.Invoke(this, $"已提取: {newFileName} (尺寸: {header.Width}x{header.Height}, 格式: {formatStr})");
